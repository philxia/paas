...
Blockly.Language.lists_repeat = {
  ...
  init: function() {
    ...
    this.appendInput(Blockly.LANG_LISTS_REPEAT_INPIT_TIMES, Blockly.DUMMY_INPUT, '', null);
...
Blockly.Language.lists_indexOf.OPERATORS =
    [[Blockly.LANG_LISTS_INDEX_OF_FIRST, 'FIRST'], [Blockly.LANG_LISTS_INDEX_OF_LAST, 'LAST']];
